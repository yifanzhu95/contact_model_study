...
def main():
    ...
    p.add_argument("--noise_sigma", type=float, default=0.23248210744804804)#0.2,)#0.1 # for M3)
    ...
    # --- MPPI-only ---------------------------------------------------------
    p.add_argument("--temperature", type=float, default=7.1877620343399595)#30.0)#20.0 <- cube
    # --- CEM-only ----------------------------------------------------------
