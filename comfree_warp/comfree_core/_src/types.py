...
class Model:
  ...
  comfree only fields:
    comfree_stiffness: stiffness of comfree constraint
    comfree_damping: damping of comfree constraint
  """
  ...
  # comfree only fields:
  comfree_stiffness: array("*", float)
  comfree_damping: array("*", float)
...
class Constraint:
  ...
  comfree only fields:
    efc_dist: general distance of constraints          (nworld, njmax)
    efc_mass: constraint mass                        (nworld, njmax)
  """
  ...
  # comfree only fields:
  efc_dist: array("nworld", "njmax", float) # general distance of constraints
  efc_mass: array("nworld", "njmax", float)  # constraint mass
...
class Data:
  ...
  comfree only fields:
  qvel_smooth_pred: (nworld, nv) predicted qvel from smooth forces
  qfrc_total: (nworld, nv) total force including constraint forces
  """
  ...
  # comfree only fields:
  qvel_smooth_pred: array("nworld", "nv", float)
  qfrc_total: array("nworld", "nv", float)
