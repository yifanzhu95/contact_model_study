...
class Constraint:
  ...
  # comfree only fields:
  efc_dist: array("nworld", "njmax", float)
  efc_mass: array("nworld", "njmax", float)
...
class Data:
  ...
  comfree only fields:
    qvel_smooth_pred: predicted qvel from smooth forces         (nworld, nv)
    qfrc_total: total force including constraint forces         (nworld, nv)
  """
